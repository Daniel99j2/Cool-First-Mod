...
public class ModItems {
    ...
    public static final Item COOLBERRY_ICECREAM = RegisterItem("coolberry_icecream", new Item(new FabricItemSettings().maxCount(16).food(ModFoodComponents.COOLBERRY_ICECREAM)));
